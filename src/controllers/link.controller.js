import { getLinks, getLinkByUserId, createLink, deleteLinkById, updateLinkById } from '../mongodb/models/link.js';
...
export const getLink = async (req, res) => {
  try {
    ...
    const link = await getLinkByUserId(user_id);
...
export const createNewLink = async (req, res) => {
  try {
    ...
    const link = await createLink({ user_id, issues });
